---
title: "XGBoost_Without_Hashtags"
...
library('pacman')
library('tidyverse')
test <- read.csv("Datasets/Tweets_With_Sarcasm_and_Irony/train_without_hashtags.csv")
train <- read.csv("Datasets/Tweets_With_Sarcasm_and_Irony/test_without_hashtags.csv")
